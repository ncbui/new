...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { firstname: @about.firstname, hobbies: @about.hobbies, lastname: @about.lastname, tagline: @about.tagline } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { firstname: @about.firstname, hobbies: @about.hobbies, lastname: @about.lastname, tagline: @about.tagline } }
